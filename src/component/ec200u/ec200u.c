...
bool Ec200uCheckSimReady(Ec200u* this) {
    ...
    return ATmodemExcutiveCmd((ATmodem*)this, cmd, "+CREG: 0,2\r\n", EC200U_NORMAL_CMD_TIMEOUT_MS, 10);
}
...
bool Ec200uCloseNetwork(Ec200u* this) {
    ...
    return ATmodemExcutiveCmd((ATmodem*)this, cmd, "+QMTCLOSE: 0,0\r\n", 30000, 3);
}
...
bool Ec200uConnectServer(Ec200u* this, char* clientID, char* username, char* password) {
    ...
    *buff++ = ',';
    ...
    return ATmodemExcutiveCmd((ATmodem*)this, cmd, "+QMTCONN: 0,0,0\r\n", 5000, 3);
}
...
bool Ec200uDisconnectServer(Ec200u* this) {
    ...
    return ATmodemExcutiveCmd((ATmodem*)this, cmd, "+QMTDISC: 0,0\r\n", 30000, 3);
}
