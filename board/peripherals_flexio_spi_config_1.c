...
/*******************************************************************************
 * flexio_spi_config_1 initialization code
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
- name: 'flexio_spi_config_1'
...
- config_sets:
  - flexio_spi_driver:
    - flexio_spi_master_Configuration:
      - 0:
        - name: 'Flexio_spi_master_Config0'
        - readonly: 'true'
        - baudRate: '100000'
    ...
    - flexio_spi_slave_Configuration:
      - 0:
        ...
        - ssPin: '3'
        - callback: 'NULL'
    - quick_selection: 'default_flexio_spi'
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
const flexio_spi_master_user_config_t Flexio_spi_master_Config0 = {
  .baudRate = 100000UL,
  .driverType = FLEXIO_DRIVER_TYPE_INTERRUPTS,
  .bitOrder = FLEXIO_SPI_TRANSFER_MSB_FIRST,
  .transferSize = FLEXIO_SPI_TRANSFER_1BYTE,
...
const flexio_spi_slave_user_config_t Flexio_spi_slave_Config0 = {
  .driverType = FLEXIO_DRIVER_TYPE_INTERRUPTS,
  .bitOrder = FLEXIO_SPI_TRANSFER_MSB_FIRST,
  .transferSize = FLEXIO_SPI_TRANSFER_1BYTE,
  .clockPolarity = 0U,
